...
更细的 SEO、Meta Description 和 Open Graph 会在 [[4、元数据、SEO与Open Graph|元数据与 Open Graph]] 中展开。
...
关于空元素的基础概念，可回看 [[1、HTML元素、属性与基础语义#3、空元素|空元素]]。
...
- 脚本加载和语义化分组会在 [[3、语义化分组、标识符与脚本加载|下一篇]] 继续整理。

...
![[assets/image-20260428141624412.png]]
...
![[assets/image-20260428142003487.png]]
...
![[assets/image-20260428142228831.png]]
...
![[assets/image-20260428142538485.png]]

​          <kbd>Enter</kbd>提交后，等待一阵子，`Claude Code`会自动生成该`Subagent`的`identifier`、`description`和`system prompt`。

![[assets/image-20260428142640665.png]]
...
![[assets/image-20260428143006790.png]]
...
![[assets/image-20260428143421704.png]]
...
![[assets/image-20260428143500365.png]]
...
![[assets/image-20260428143708368.png]]
...
如果觉得没有问题，按`s`或<kbd>Enter</kbd>保存。

如果觉得还需要自行修改，按`e`在编辑器打开文件进行编辑。

![[assets/image-20260428144547518.png]]

保存后，因为默认生成的是英文版本，因此可以让`Claude Code`改成中文版本：

![[assets/image-20260428145215608.png]]
...
![[assets/image-20260428145720094.png]]

可以看到最终给出了符合要求的改进建议：

![[assets/image-20260428145830072.png]]
...
![[assets/image-20260428150449194.png]]
...
![[assets/image-20260428150817120.png]]
...
例如创建一个只读数据库查询的子代理。`PreToolUse`钩子会在每个`Bash`命令执行前运行<kbd>Command</kbd>中指定的脚本：
...
- 按 <kbd>Ctrl</kbd> + <kbd>B</kbd> 将正在运行的任务转为后台
